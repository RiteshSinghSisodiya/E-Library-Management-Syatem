                ...
                <div class="card-body">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <asp:LinkButton class="btn btn-primary btn-sm" ID="LinkButton5" runat="server" OnClick="LinkButton5_Click1"><i class="fas fa-check-circle"></i></asp:LinkButton>
                                </div>
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <asp:LinkButton class="btn btn-success mr-1 btn-sm" ID="LinkButton1" runat="server" OnClick="LinkButton1_Click"><i class="fas fa-check-circle"></i></asp:LinkButton>

                                    <asp:LinkButton class="btn btn-warning mr-1 btn-sm" ID="LinkButton2" runat="server" OnClick="LinkButton2_Click"><i class="far fa-pause-circle"></i></asp:LinkButton>

                                    <asp:LinkButton class="btn btn-danger mr-1 btn-sm" ID="LinkButton3" runat="server" OnClick="LinkButton3_Click"><i class="fas fa-times-circle"></i></asp:LinkButton>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="form-group">
                                <asp:TextBox CssClass="form-control" ID="TextBox4" runat="server" placeholder="Example@gmail.com" ReadOnly="True"></asp:TextBox>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-8 mx-auto">
                            <center>
                                <asp:Button ID="Button2" class="btn btn-lg btn-block btn-danger" runat="server" Text="Delete User Premanently" OnClick="Button2_Click" />
                            </center>
                        </div>
